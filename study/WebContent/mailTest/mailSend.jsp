...
<title>메일 보내기</title>
<link rel="stylesheet" type="text/css" href="<%=cp%>/mailTest/data/style.css">
<script type="text/javascript" src="<%=cp%>/mailTest/data/mail.js"></script>
...
<table width="650" border="2" cellpadding="0" cellspacing="0" 
...
<form action="mailSend_ok.jsp" method="post" name="myForm"
...
<tr>
	<td width="140" height="3" bgcolor="#eeeeee" 
